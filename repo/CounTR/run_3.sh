...
CUDA_VISIBLE_DEVICES=0 python -u FSC_finetune_cross.py --wandb debug --epochs 50 --epochs_per_save 10 --batch_size 8 --lr 1e-5 --output_dir ${dir} --adaption --extract resnet18 --title finetuning_${tag} --resume ${dir}/checkpoint__finetuning_minMAE.pth | tee logs/val_${tag}.log
